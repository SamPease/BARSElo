...
def main():
    ...
    ap.add_argument('--model', choices=['elo','trueskill','trueskill_mov','bt_mov','bt_mov_time_decay','bt_vet','bt_uncert','bt_normal','ttt'], help='Train only this model (default: all models in config)')
